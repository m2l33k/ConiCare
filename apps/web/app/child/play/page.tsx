        ...
        <div className="bg-white/90 backdrop-blur-md rounded-3xl p-8 shadow-2xl max-w-4xl w-full relative">
           <div className="flex justify-between items-center mb-8">
              ...
              <div className="flex gap-6 text-2xl font-bold text-slate-600">
                 <div className="bg-white px-4 py-2 rounded-xl shadow-sm">Moves: {moves}</div>
                 <div className="bg-white px-4 py-2 rounded-xl shadow-sm text-blue-600">Score: {score}</div>
              </div>
           </div>
           ...
           {gameOver && (
              <div className="absolute inset-0 flex items-center justify-center bg-black/50 rounded-3xl z-30 backdrop-blur-sm">
                 <div className="bg-white p-12 rounded-[2rem] text-center animate-scale-in shadow-2xl">
                    <h3 className="text-5xl font-black text-slate-800 mb-4">You Won! 🎉</h3>
                    <p className="text-2xl text-slate-600 mb-8">Final Score: {score}</p>
                    <button 
                        onClick={restartGame} 
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen w-screen overflow-hidden relative font-rounded select-none">
      ...
      <div className="absolute inset-0 bg-sky-300 z-0 overflow-hidden">
        {/* Sun */}
        <div className="absolute top-10 right-20 w-32 h-32 bg-yellow-300 rounded-full shadow-[0_0_40px_rgba(253,224,71,0.6)] animate-pulse-slow" />
        {/* Clouds */}
        <div className="absolute top-20 left-20 w-40 h-20 bg-white/80 rounded-full blur-xl opacity-80" />
        <div className="absolute top-40 right-1/3 w-60 h-24 bg-white/60 rounded-full blur-xl opacity-60" />
        {/* Hills */}
      ...
      <div className="relative z-10 grid grid-cols-3 gap-12 w-full max-w-6xl px-8">
        ...
        >
          ...
          <span className="text-4xl font-black text-slate-700 relative z-10">Memory</span>
        </button>
        ...
        <button className="bg-white h-96 rounded-[3rem] border-b-[16px] border-purple-200 shadow-xl hover:shadow-2xl hover:-translate-y-4 transition-all duration-300 group flex flex-col items-center justify-center gap-8 relative overflow-hidden mt-12">
          ...
          <span className="text-4xl font-black text-slate-700 relative z-10">Focus</span>
        </button>
        ...
        <button className="bg-white h-96 rounded-[3rem] border-b-[16px] border-amber-200 shadow-xl hover:shadow-2xl hover:-translate-y-4 transition-all duration-300 group flex flex-col items-center justify-center gap-8 relative overflow-hidden">
          ...
          <span className="text-4xl font-black text-slate-700 relative z-10">Story</span>
        </button>
      ...
      {showExitModal && (
        <div className="fixed inset-0 bg-black/80 z-[100] flex items-center justify-center p-4 backdrop-blur-sm">
          <div className="bg-white rounded-[2rem] p-8 w-full max-w-sm text-center shadow-2xl animate-scale-in">
            ...
            <p className="text-slate-500 mb-6">Enter PIN to exit</p>
