    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm flex items-center gap-4">
          ...
          <div>
            <p className="text-slate-500 text-sm font-medium">{t('avgScore')}</p>
            ...
            <p className="text-green-600 text-xs font-bold flex items-center gap-1">
              <TrendingUp size={12} /> {t('avgPerformance')}
            </p>
          </div>
        </div>
        ...
        <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm flex items-center gap-4">
          ...
          <div>
            <p className="text-slate-500 text-sm font-medium">{t('gamesCompleted')}</p>
        ...
        <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm flex items-center gap-4">
          ...
          <div>
            <p className="text-slate-500 text-sm font-medium">{t('activePrescriptions')}</p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
           <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm">
            <div className="flex items-center justify-between mb-6">
              <h3 className="font-bold text-slate-900">{t('performanceEvolution')}</h3>
            </div>
            <div className="h-80">
              {chartData.length > 0 ? (
        ...
        <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm h-fit">
          <h3 className="font-bold text-slate-900 mb-4">{t('prescriptionsTitle')}</h3>
